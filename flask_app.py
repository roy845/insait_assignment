...
def create_app(testing:bool = False):
    ...
    app = Flask(__name__)
    app.config['TESTING'] = True if testing == True else False
    app.config['SQLALCHEMY_DATABASE_URI'] = settings.database_test_url if testing == True else settings.database_prod_url
